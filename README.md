...
A local dashboard for **Claude**, **ChatGPT / Codex**, and **Grok** subscription usage. This
Combined edition uses the GPT-6 foundation and improvements from Claude and Grok,
...
```sh
git clone https://github.com/JoshuaMaiorino/usage-tracker.git
cd usage-tracker
npm ci
...
The default Git branch is `main`. This public repository starts with a reviewed snapshot of the
combined build. Local development history and personal runtime settings are not included.
